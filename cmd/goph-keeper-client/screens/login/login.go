...
// Name is the canonical identifier for the login screen.
var Name = "login"

// Screen implements the TUI state and behavior for the login view.
type Screen struct {
	api        *api.APIClient
	options    []string
...
// NewScreen constructs a login Screen wired with an API client.
...
// Init initializes input models and internal state for the login Screen.
...
// Update processes incoming messages and updates the login Screen
...
// View renders the login Screen as a string for display by the TUI.
